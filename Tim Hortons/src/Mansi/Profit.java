		...
		ResultSet rs2 = null;
        	...
        	try {
        		...
        		Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            		...
            		String SQL2 = "select distinct WhichYear from Cash_Flow";
        			...
        			RequestDispatcher rd=getServletContext().getRequestDispatcher("/Profit.jsp");
		...
		if(request.getParameter("Submit")!=null)
		{
	    	...
	    	try {
	    		...
	    		Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
	        		...
	        		{
	        			 SQL = "select DayId,profit from Cash_Flow  where customerName='"+Cust+"'";
	        		}
	        		if(Cust.equals("CustomerName") && !Month.equals("Month") &&  year.equals("Years"))
	        		{
	        			 SQL = "select DayId,profit from Cash_Flow  where NameofMonth='"+Month+"'";
	        		}
	        		if(Cust.equals("CustomerName") && Month.equals("Month") &&  !year.equals("Years"))
	        		{
	        			 SQL = "select DayId,profit from Cash_Flow  where WhichYear='"+year+"'";
	        		}
	        		 if(!Cust.equals("CustomerName") && !Month.equals("Month")&&  year.equals("Years"))
	        		 {
	        			 SQL = "select DayId,profit from Cash_Flow  where customerName='"+Cust+"' and NameofMonth='"+Month+"'";
	        		 }
	        		 if(!Cust.equals("CustomerName") && Month.equals("Month")&&  !year.equals("Years"))
	        		 {
	        			 SQL = "select DayId,profit from Cash_Flow  where customerName='"+Cust+"' and WhichYear='"+year+"'";
	        		 }
	        		 if(Cust.equals("CustomerName") && !Month.equals("Month")&&  !year.equals("Years"))
	        		 {
	        			 SQL = "select DayId,profit from Cash_Flow  where NameofMonth='"+Month+"' and WhichYear='"+year+"'";
	        		 }
	        		if(!Cust.equals("CustomerName") && !Month.equals("Month")&&  !year.equals("Years") )
	        		{
	        			 SQL = "select DayId,profit from Cash_Flow  where customerName='"+Cust+"' and NameofMonth='"+Month+"' and WhichYear='"+year+"'";
	        		}
	        		...
	        		// Iterate through the data in the result set and display it.
	        		while (rs.next()) {
	        			Days[rs.getInt("DayId")-1]= rs.getInt("profit");
	        		}
